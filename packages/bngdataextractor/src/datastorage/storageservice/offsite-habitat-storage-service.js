...
class OffSiteHabitatStorageService {
  #habitatBaseline
  ...
  storeExtractedData = async (extractedData) => {
    ...
    const habitatRecord = []
    const applicationReference = extractedData.startPage['Planning application reference']
    extractedData.siteHabitatBaseline.forEach(habita => {
      ...
      const score1 = habita.Score_1
      const strategicSignificance = habita['Strategic significance']
      const strategicSignificance1 = habita['Strategic significance_1']
...
export default OffSiteHabitatStorageService
