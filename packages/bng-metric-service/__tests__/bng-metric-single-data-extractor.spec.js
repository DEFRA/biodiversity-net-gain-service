...
describe('BNG data extractor test', () => {
  ...
  it('should be transfer excel stream to json for start with endcell', async () => {
    const startExtractionConfig = bngMetricService.extractionConfiguration.startExtractionConfig
  ...
  it('should transform excel stream to json for A-1 Site Habitat Baseline if specified column to be removed', async () => {
    const habitatBaselineExtractionConfig = bngMetricService.extractionConfiguration.habitatBaselineExtractionConfig
