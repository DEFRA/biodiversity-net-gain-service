...
const DEV_DETAILS_CHECKED = 'developer-details-checked'
...
const DEVELOPER_ROUTING_REGISTER_VALUE = 'developer-routing-register-value'
const DEVELOPER_WRITTEN_CONTENT_VALUE = 'developer-written-consent-value'
const BIODIVERSITY_NET_GAIN_NUMBER = 'developer-biodiversity-net-gain-number'
const DEVELOPER_ADDITIONAL_EMAILS = 'developer-additional-emails'
const CONFIRM_OFFSITE_GAIN_CHECKED = 'developer-offsite-details-checked'
...
const DEVELOPER_CONSENT_TO_USE_GAIN_SITE_UPLOAD_TYPE = 'developer-consent-to-use-gain'
const DEVELOPER_CONSENT_TO_USE_GAIN_SITE_FILE_LOCATION = 'developer-consent-to-use-gain-site-location'
const DEVELOPER_CONSENT_TO_USE_GAIN_SITE_FILE_SIZE = 'developer-consent-to-use-gain-site-file-size'
const DEVELOPER_CONSENT_TO_USE_GAIN_SITE_FILE_TYPE = 'developer-consent-to-use-gain-site-file-type'
const DEVELOPER_CONSENT_TO_USE_GAIN_SITE_FILE_NAME = 'developer-consent-to-use-gain-site-file-name'
const DEVELOPER_CONSENT_TO_USE_GAIN_SITE_CHECKED = 'developer-consent-to-use-gain-site-checked'
