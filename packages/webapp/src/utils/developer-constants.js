...
const DEVELOPER_LANDOWNER_OR_LEASEHOLDER_VALUE = 'developer-landowner-or-leaseholder'
const MULTIPLE_PROOFS_OF_PERMISSION_REQUIRED = 'developer-multiple-proof-permission-required'
...
const DEVELOPER_WRITTEN_AUTHORISATION_FILES = 'written-authorisation-files'
...
export default {
  ...
  redisKeys: {
    ...
    DEVELOPER_LANDOWNER_OR_LEASEHOLDER_VALUE,
    MULTIPLE_PROOFS_OF_PERMISSION_REQUIRED,
    DEVELOPER_LANDOWNER_TYPE,
    DEVELOPER_CLIENT_INDIVIDUAL_ORGANISATION,
    DEVELOPER_CLIENTS_NAME,
    DEVELOPER_CLIENTS_ORGANISATION_NAME,
    DEVELOPER_WRITTEN_AUTHORISATION_FILES,
