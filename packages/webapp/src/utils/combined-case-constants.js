...
const reusedRoutes = {
  ...
  COMBINED_CASE_DOWNLOAD_PLANNING_DECISION_FILE: reusedRoutePath(baseUrl, DEVELOPER_DOWNLOAD_PLANNING_DECISION_FILE),
  ...
  COMBINED_CASE_DOWNLOAD_LAND_OWNERSHIP: reusedRoutePath(baseUrl, DOWNLOAD_LAND_OWNERSHIP),
  COMBINED_CASE_DOWNLOAD_WRITTEN_AUTHORISATION: reusedRoutePath(baseUrl, DOWNLOAD_WRITTEN_AUTHORISATION),
  COMBINED_CASE_DOWNLOAD_LAND_BOUNDARY: reusedRoutePath(baseUrl, DOWNLOAD_LAND_BOUNDARY),
  COMBINED_CASE_DOWNLOAD_METRIC_FILE: reusedRoutePath(baseUrl, DOWNLOAD_METRIC_FILE),
  COMBINED_CASE_DOWNLOAD_LEGAL_AGREEMENT: reusedRoutePath(baseUrl, DOWNLOAD_LEGAL_AGREEMENT),
  COMBINED_CASE_DOWNLOAD_HABITAT_PLAN_FILE: reusedRoutePath(baseUrl, DOWNLOAD_HABITAT_PLAN_FILE)
}
