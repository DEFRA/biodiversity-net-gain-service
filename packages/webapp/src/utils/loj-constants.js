...
const LANDOWNER_CONSENT = 'land/consent-to-register'
...
const LANDOWNER_CONSENT_NO = 'land/no-landowner-consent'
const LANDOWNER_PERMISSION_UPLOAD = 'land/upload-consent'
const LANDOWNER_PERMISSION_CHECK = 'land/check-consent-file'
const ERROR = 'error'
const HOME = 'home'
