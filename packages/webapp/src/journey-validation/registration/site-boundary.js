...
const UPLOAD_LAND_BOUNDARY = routeDefinition(
  ...
  [
    constants.cacheKeys.LAND_BOUNDARY_LOCATION,
    constants.cacheKeys.LAND_BOUNDARY_FILE_SIZE,
    constants.cacheKeys.LAND_BOUNDARY_FILE_TYPE
  ]
)

const CHECK_LAND_BOUNDARY = routeDefinition(
  constants.routes.CHECK_LAND_BOUNDARY,
  [constants.cacheKeys.LAND_BOUNDARY_CHECKED]
)

const ADD_GRID_REFERENCE = routeDefinition(
  constants.routes.ADD_GRID_REFERENCE,
  [constants.cacheKeys.LAND_BOUNDARY_GRID_REFERENCE]
)

const ADD_HECTARES = routeDefinition(
  constants.routes.ADD_HECTARES,
  [constants.cacheKeys.LAND_BOUNDARY_HECTARES]
)
