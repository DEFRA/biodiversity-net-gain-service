...
const thisView = combinedCaseConstants.views.COMBINED_CASE_ALLOCATION_UPLOAD_METRIC
...
export default [{
  method: 'GET',
  path: combinedCaseConstants.routes.COMBINED_CASE_ALLOCATION_UPLOAD_METRIC,
...
const maximumFileSizeExceeded = h => {
  return getMaximumFileSizeExceededView({
    ...
    view: combinedCaseConstants.views.COMBINED_CASE_ALLOCATION_UPLOAD_METRIC,
    href: UPLOAD_CREDIT_METRIC_ID,
    h
  })
}
