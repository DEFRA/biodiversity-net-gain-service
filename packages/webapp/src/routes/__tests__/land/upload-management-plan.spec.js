...
describe('Management plan upload controller tests', () => {
  ...
  describe('POST', () => {
    ...
    it('should upload management plan document less than 50MB', (done) => {
      jest.isolateModules(async () => {
        try {
          const uploadConfig = Object.assign({}, baseConfig)
    ...
    it('should not upload management plan document more than 50MB', (done) => {
      jest.isolateModules(async () => {
        try {
          const uploadConfig = Object.assign({}, baseConfig)
    ...
    it('should not upload managenent plan document larger than the configured maximum', (done) => {
      jest.isolateModules(async () => {
        try {
