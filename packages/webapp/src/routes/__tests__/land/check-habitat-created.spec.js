...
describe(url, () => {
  describe('GET', () => {
    ...
    it(`should render the ${url.substring(1)} view`, async () => {
      ...
      expect(viewArgs[1].combinedHabitatTypeAndCondition).toEqual(JSON.parse('[{"type":"Habitat","unitKey":"Area (hectares)","unit":"Area (ha)","header":"Broad habitat","description":"Proposed habitat","total":20.001,"items":[{"header":"Wetland","description":"Fens (upland and lowland)","condition":"Moderate","amount":0.529},{"header":"Wetland","condition":"Good","amount":19.472}],"dataTestId":"habitatTotal"},{"type":"Hedgerow","unitKey":"Length (km)","unit":"Length (km)","description":"Habitat type","total":24,"items":[{"description":"Native species-rich hedgerow with trees","condition":"Moderate","amount":20},{"description":"Native Species-rich native hedgerow with trees - associated with bank or ditch","condition":"Good","amount":2},{"description":"Native hedgerow with trees - associated with bank or ditch","condition":"Good","amount":2}],"dataTestId":"hedgeTotal"},{"type":"River","unitKey":"Length (km)","unit":"Length (km)","description":"Watercourse type","total":45,"items":[{"description":"Other Rivers and Streams","condition":"Fairly Good","amount":5},{"description":"Other Rivers and Streams","condition":"Fairly Good","amount":20},{"description":"Priority Habitat","condition":"Fairly Good","amount":20}],"dataTestId":"riverTotal"}]'))
    })
  })
  describe('POST', () => {
