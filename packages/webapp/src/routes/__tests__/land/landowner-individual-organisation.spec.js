...
describe(url, () => {
  ...
  describe('POST', () => {
    it('Should continue journey to ADD_LANDOWNER_INDIVIDUAL if landownerType is individual', async () => {
      const request = {
        yar: redisMap,
    ...
    it('Should continue journey to ADD_LANDOWNER_ORGANISATION if landownerType is organisation', async () => {
      const request = {
        yar: redisMap,
