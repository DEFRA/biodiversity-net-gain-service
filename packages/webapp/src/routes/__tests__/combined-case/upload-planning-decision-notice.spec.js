...
const url = constants.reusedRoutes.COMBINED_CASE_UPLOAD_PLANNING_DECISION_NOTICE
...
describe('Uplocad Planning Decision Notice tests', () => {
  ...
  describe('POST', () => {
      ...
      jest.isolateModules(async () => {
        try {
          ...
          uploadConfig.headers = {
            referer: 'http://localhost:30000/combined-case/check-planning-decision-notice-file'
          }
    ...
    it('should not upload nofile planning decision notice file', (done) => {
      jest.isolateModules(async () => {
        try {
          const uploadConfig = Object.assign({}, baseConfig)
          uploadConfig.hasError = true
