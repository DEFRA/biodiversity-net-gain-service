...
const submitGetRequest = async (options, expectedResponseCode = 200, sessionData, config = { expectedNumberOfPostJsonCalls: sessionData && sessionData[constants.cacheKeys.SAVE_APPLICATION_SESSION_ON_SIGNOUT_OR_JOURNEY_CHANGE] ? 1 : 0 }) => {
