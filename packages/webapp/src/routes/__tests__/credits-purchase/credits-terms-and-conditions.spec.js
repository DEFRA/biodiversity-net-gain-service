...
const url = creditsPurchaseConstants.routes.CREDITS_TERM_AND_CONDITIONS
...
describe(url, () => {
  ...
  describe('POST', () => {
    ...
    it('Should continue journey to consent being ticked', async () => {
      ...
      expect(res.headers.location).toEqual(creditsPurchaseConstants.routes.CREDITS_CHECK_YOUR_ANSWERS)
    })
