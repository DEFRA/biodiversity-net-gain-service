...
const url = constants.routes.DEVELOPER_DOWNLOAD_WRITTEN_AUTHORISATION
...
describe(url, () => {
  describe('GET', () => {
    it('It should download the mocked document from blobStorageConnector', async () => {
      ...
      sessionData[constants.redisKeys.DEVELOPER_WRITTEN_AUTHORISATION_LOCATION] = 'written-authorisation.pdf'
