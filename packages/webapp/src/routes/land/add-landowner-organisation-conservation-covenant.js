...
const validateOrganisation = organisation => {
  const errors = {}
  const organisationNameError = validateTextInput(organisation.organisationName, organisationNameID, 'Organisation name', null, null, 'landowner or leaseholder')
...
const handlers = {
  get: async (request, h) => {
    processRegistrationTask(request, {
      ...
      title: 'Add landowner organisation details'
    }, {
