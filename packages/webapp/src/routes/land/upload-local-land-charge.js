...
async function processSuccessfulUpload (result, request, h) {
  await deleteBlobFromContainers(request.yar.get(constants.cacheKeys.LOCAL_LAND_CHARGE_LOCATION, true))
  request.yar.set(constants.cacheKeys.LOCAL_LAND_CHARGE_LOCATION, result.config.blobConfig.blobName)
  request.yar.set(constants.cacheKeys.LOCAL_LAND_CHARGE_FILE_SIZE, result.fileSize)
  request.yar.set(constants.cacheKeys.LOCAL_LAND_CHARGE_FILE_TYPE, result.fileType)
