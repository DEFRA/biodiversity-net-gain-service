  ...
  post: async (request, h) => {
    ...
    if (err) {
      ...
      if (!isPointInEngland) {
        ...
        return h.redirect((request.yar.get(constants.cacheKeys.LAND_BOUNDARY_HECTARES) && request.yar.get(constants.cacheKeys.REFERER, true)) || constants.routes.ADD_HECTARES)
      }
    }
  }
}
