...
const handlers = {
  get: async (request, h) => {
    ...
    const address = request.yar.get(constants.cacheKeys.NON_UK_ADDRESS_KEY)
  ...
  post: async (request, h) => {
    ...
    if (errors) {
      ...
      request.yar.set(constants.cacheKeys.NON_UK_ADDRESS_KEY, address)
      request.yar.set(constants.cacheKeys.UK_ADDRESS_KEY, null)
