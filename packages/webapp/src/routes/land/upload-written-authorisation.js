...
const processSuccessfulUpload = async (result, request, h) => {
  await deleteBlobFromContainers(request.yar.get(constants.cacheKeys.WRITTEN_AUTHORISATION_LOCATION, true))
  request.yar.set(constants.cacheKeys.WRITTEN_AUTHORISATION_LOCATION, result.config.blobConfig.blobName)
  request.yar.set(constants.cacheKeys.WRITTEN_AUTHORISATION_FILE_SIZE, result.fileSize)
  request.yar.set(constants.cacheKeys.WRITTEN_AUTHORISATION_FILE_TYPE, result.fileType)
