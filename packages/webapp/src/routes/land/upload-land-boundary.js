...
async function processSuccessfulUpload (result, request, h) {
  ...
  const previousBlobPath = request.yar.get(constants.redisKeys.LAND_BOUNDARY_LOCATION, true)
  await deleteBlobFromContainersWithCheck(blobPath, previousBlobPath)
  request.yar.set(constants.redisKeys.LAND_BOUNDARY_LOCATION, blobPath)
