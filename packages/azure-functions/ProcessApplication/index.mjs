...
export default async function (context, req) {
  ...
  try {
    ...
    if (!req.body.landownerGainSiteRegistration.gainSiteReference) {
      ...
      req.body.landownerGainSiteRegistration.gainSiteReference = applicationReference.rows[0].application_reference
      req.body.landownerGainSiteRegistration.payment.reference = applicationReference.rows[0].application_reference
    } else {
