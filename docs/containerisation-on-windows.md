...
3. Restart your PC.
4. Set up Ubuntu:
   - Once your PC has restarted, open the Ubuntu app from the Start Menu.
...
6. Open WSL2 and update/upgrade Ubuntu:
   ...
   - Update and upgrade Ubuntu with the following commands:
     ...
     ```
7. Install Azure core functions:
   ...
   - Verify its installation with:
     ...
     func --version
     ```
8. Install Git and clone the project:
   - Install Git with:
     ```bash
