...
sh -c 'echo "deb [signed-by=/etc/apt/trusted.gpg.d/nodesource.gpg] https://deb.nodesource.com/node_20.x $(lsb_release -s -c) main" > /etc/apt/sources.list.d/nodesource.list'
